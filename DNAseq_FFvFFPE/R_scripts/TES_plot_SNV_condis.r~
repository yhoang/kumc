...
textcolor = "#2E2E2E";
SNV_FILE = sprintf("/project/results/me/WES/plots/SNV_condis_barplot/WES_SNV_%s%s",targeted,threshold);
pdffile = sprintf("/project/results/me/WES/plots/SNV_condis_barplot/WES_%sSNV_condis_%s.pdf",targeted,threshold);
...
max=280000
y_tick = c((0:6)*50000)
SNV_FILE = sprintf("/project/results/me/WES/plots/SNV_condis_barplot/WES_SNV_%s",threshold);
pdffile = sprintf("/project/results/me/WES/plots/SNV_condis_barplot/WES_SNV_condis_%s.pdf",threshold);
