...
file_con = sprintf("/project/results/me/TES/SNV_comparison/genotyper/with_intersection/stats/%s_FF_FFPE_%s_%scon.tsv",SAMPLE[s],threshold,targeted);
file_dis = sprintf("/project/results/me/TES/SNV_comparison/genotyper/with_intersection/stats/%s_FF_FFPE_%s_%sdis.tsv",SAMPLE[s],threshold,targeted);

pdffile = sprintf("/project/results/me/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
pdffile_fw = sprintf("/project/results/me/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_forward_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
pdffile_rv = sprintf("/project/results/me/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_reverse_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
