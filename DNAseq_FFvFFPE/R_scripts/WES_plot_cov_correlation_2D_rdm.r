targeted = "";
INTERSECTION = c(204500303,206852611,400903833,249049537,322326676,308511694,211025704,311521345,227264708,227512155,220974543,103456164,90009963)
INTERSECTION = c(1485506,1488772,1490697,1487362,1511603,1507599,1485653,1487415,1503449,1500079,1493300,1371869,1277918)
targeted = "targeted_";
...
file = sprintf("/project/results/me/WES/pileup_distribution/%s_FFex_FFPEex_%sintersect.distribution",SAMPLE[s],targeted);
pdffile = sprintf("/project/results/me/WES/plots/cov_correlation/2D/intersection/%s/WES_%s%s_FFex_FFPEex_pearson_correlation.pdf",random,targeted,SAMPLE[s]);
pdffile_fw = sprintf("/project/results/me/WES/plots/cov_correlation/2D/intersection/%s/WES_%s%s_FFex_FFPEex_forward_pearson_correlation.pdf",random,targeted,SAMPLE[s]);
pdffile_rv = sprintf("/project/results/me/WES/plots/cov_correlation/2D/intersection/%s/WES_%s%s_FFex_FFPEex_reverse_pearson_correlation.pdf",random,targeted,SAMPLE[s]);
