...
file2 = sprintf("/project/results/me/WES/pileup_distribution/%s_transition_2motifs_ant.txt",target);
...
file1 = sprintf("/project/results/me/WES/pileup_distribution/%s_transition_2motifs_sub.txt",target);
...
pdffile = sprintf("/project/results/me/WES/plots/conversion/WES_%s_transition_2motifs_group1.pdf",target);
...
pdffile = sprintf("/project/results/me/WES/plots/conversion/WES_%s_transition_2motifs_group2.pdf",target);
pdf (file = pdffile, width=10, height = 4, pointsize=1)
	par (las = 1, mfrow = c(1,2), mar=c(5,8,1,2),oma=c(0,2,0,0),col=textcolor)
