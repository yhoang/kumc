# creating /home/yhoang/Documents/me/plot_data/WES/plots/conversion/WES_transition_2motifs_ungrouped_main.pdf
...
##### MAIN FILE
pdffile = sprintf("/home/yhoang/Documents/me/plot_data/WES/plots/conversion/WES_transition_2motifs_ungrouped_main.pdf",target);
...
### C>T subsequent
	boxplot ( tableCsub,  xaxt = "n", yaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
	 col=c("#9ACD32","#1E90FF"), fill=c("#9ACD32","#1E90FF"), cex.main=1, cex=1, cex.axis=3, col.lab=textcolor, col.axis=textcolor, adj=1, font.lab=2, cex.lab=7,ylab="WES")
