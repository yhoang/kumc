# creating /home/yhoang/Documents/me/plot_data/WES/plots/conversion/WES_transition_2motifs_main.pdf
...
fileCsub = "/home/yhoang/Documents/me/plot_data/WES/pileup_distribution/C_transition_2motifs_sub.txt";
...
fileCant = "/home/yhoang/Documents/me/plot_data/WES/pileup_distribution/C_transition_2motifs_ant.txt";
...
fileGsub = "/home/yhoang/Documents/me/plot_data/WES/pileup_distribution/G_transition_2motifs_sub.txt";
...
fileGant = "/home/yhoang/Documents/me/plot_data/WES/pileup_distribution/G_transition_2motifs_ant.txt";
...
##### MAIN FILE
pdffile = sprintf("/home/yhoang/Documents/me/plot_data/WES/plots/conversion/WES_transition_2motifs_main.pdf",target);
...
### Group 1 C>T subsequent
	boxplot ( groupC1sub,  xaxt = "n", yaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
	 col=c("#9ACD32","#1E90FF"), fill=c("#9ACD32","#1E90FF"), cex.main=1, cex=1, cex.axis=3.5, col.lab=textcolor, col.axis=textcolor, adj=1, font.lab=2, cex.lab=9,ylab="Group 1")
