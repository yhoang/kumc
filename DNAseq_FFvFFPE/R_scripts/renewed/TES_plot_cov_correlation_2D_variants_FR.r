...
file_con = sprintf("/home/yhoang/Documents/me/plot_data/TES/SNV_comparison/genotyper/with_intersection/stats/%s_FF_FFPE_%s_%scon.tsv",SAMPLE[s],threshold,targeted);
file_dis = sprintf("/home/yhoang/Documents/me/plot_data/TES/SNV_comparison/genotyper/with_intersection/stats/%s_FF_FFPE_%s_%sdis.tsv",SAMPLE[s],threshold,targeted);

pdffile = sprintf("/home/yhoang/Documents/me/plot_data/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
pdffile_fw = sprintf("/home/yhoang/Documents/me/plot_data/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_forward_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
pdffile_rv = sprintf("/home/yhoang/Documents/me/plot_data/TES/plots/cov_correlation/2D/SNV_FR/%s/TES_%s%s_FF_FFPE_%s_reverse_pearson_correlation.pdf",threshold,targeted,SAMPLE[s],threshold);
