...
##### SUPPLEMENT FILE
pdffile = sprintf("/home/yhoang/Documents/me/plot_data/TES/plots/conversion/TES_transition_2motifs_supplement.pdf",target);
pdf (file = pdffile, width=20, height = 4, pointsize=1)
	par (las = 1, mfrow = c(1,4), mar=c(5,9,1,5),oma=c(0,0,0,0),col=textcolor)
	
### Group 1 C>T antecedent
	boxplot ( groupC1ant,  xaxt = "n", yaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
	 col=c("#9ACD32","#1E90FF"), fill=c("#9ACD32","#1E90FF"), cex.main=1, cex=1, cex.axis=3.5, col.lab=textcolor, col.axis=textcolor, adj=2, font.lab=1, cex.lab=9,ylab="Group 1")
...
### Group 1 G>A subsequent
	boxplot ( groupG1sub,  xaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
...
### Group 2 C>T antecedent
	boxplot ( groupC2ant,  xaxt = "n", yaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
...
### Group 2 G>A subsequent
	boxplot ( groupG2sub,  xaxt = "n", staplewex = 1, boxwex=0.4, ylim = c( 0.0008,0.0076),
	 col=c("#9ACD32","#1E90FF"), fill=c("#9ACD32","#1E90FF"), cex.main=1, cex=1,cex.axis=3.5, col.lab=textcolor, col.axis=textcolor, adj=1, font.lab=2, cex.lab=2.2)
	mtext("  AG>AA  TG>TA  GG>GA CG>CA", side=1,line=2.5, cex=3, col=textcolor,adj=0, font =2)	
