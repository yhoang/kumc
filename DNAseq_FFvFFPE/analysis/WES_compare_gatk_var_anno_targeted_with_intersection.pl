...
# Compares annotated SNVs between FF and FFPE in targeted intersected positions.

print strftime "%Y-%m-%d %H:%M:%S", localtime(time);
print "\n";
print STDERR "./WES_compare_gatk_var_anno_targeted_with_intersection.pl \n";


print STDERR "./compare_gatk_var_anno_targeted_with_intersection.pl \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	foreach my $p (@method) {
		...
		$WRITE_CON = ">/project/results/me/WES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FFex_FFPEex_${p}_targeted_con";
		$WRITE_DIS = ">/project/results/me/WES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FFex_FFPEex_${p}_targeted_dis";
