...
print STDERR "./WGS_compare_gatk_var_anno_exonic_with_intersection.pl \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	foreach my $p (@method) {
		...
		$FF = "</project/results/me/WGS/$sample[$o]_FF/genotyper/anno/$sample[$o]_FFgen.bwa.ug.snp_${p}.exome_summary.csv";
		$FFPE = "</project/results/me/WGS/$sample[$o]_FFPE/genotyper/anno/$sample[$o]_FFPEgen.bwa.ug.snp_${p}.exome_summary.csv";
		$WRITE_CON = ">/project/results/me/WGS/SNV_comparison/genotyper/with_intersection/$sample[$o]_FF_FFPE_${p}_exonic_con";
		$WRITE_DIS = ">/project/results/me/WGS/SNV_comparison/genotyper/with_intersection/$sample[$o]_FF_FFPE_${p}_exonic_dis";
