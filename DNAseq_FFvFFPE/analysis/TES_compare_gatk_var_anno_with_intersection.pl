...
print STDERR "./TES_compare_gatk_var_anno_with_intersection.pl \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	foreach my $p (@method) {
		...
		$WRITE_CON = ">/project/results/me/TES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FF_FFPE_${p}_con";
		$WRITE_DIS = ">/project/results/me/TES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FF_FFPE_${p}_dis";
