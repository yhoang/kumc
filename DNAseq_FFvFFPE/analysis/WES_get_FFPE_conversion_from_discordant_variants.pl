...
print "\n";
print "./WES_get_FFPE_conversion_from_discordant_basecall_variants.pl \n";

our $p = ( "q43cov13");
our @sample = ("2474","2561","2640","2685","2938","3050","3356","4079","4191");
...
for ( my $k = 0; $k <=$#sample; $k++) {
	...
	$title2 = $title2."\t$sample[$k]";
 	my $dis_file = "</project/results/me/WES/SNV_comparison/genotyper/with_intersection/exonic/$sample[$k]_FFex_FFPEex_${p}_exonic_dis";
