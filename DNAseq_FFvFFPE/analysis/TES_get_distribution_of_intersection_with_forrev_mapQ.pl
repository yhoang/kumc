...
for (my $o = 0; $o <= $#sample; $o++) {
    ...
    $write_distribution = ">/project/results/me/TES/pileup_distribution/$sample[$o]_FF_FFPE_intersect.distribution"; 
	
	my %FF; my @read = ();
	my ($it_FF, $it_FFPE, $intersect) = qw/0 0 0/;	
