...
print "\n";
print "./WES_get_distribution_of_targeted_intersection_with_forrev_mapQ.pl\n--> Get positions that were in both files! \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	$FF = "</project/results/me/WES/$sample[$o]_FFex/$sample[$o]_FFex.cns.starless.pileup";	
        ...
        $write_distribution = ">/project/results/me/WES/pileup_distribution/$sample[$o]_FFex_FFPEex_targeted_intersect.distribution"; 
