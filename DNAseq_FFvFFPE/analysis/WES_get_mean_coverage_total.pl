...
print "\n";
print STDERR "./WES_get_mean_coverage_total.pl  \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	my $distribution_file = "</project/results/me/WES/pileup_distribution/$sample[$o]_FFex_FFPEex_intersect.distribution";
