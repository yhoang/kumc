...
print "\n";
print STDERR "./TES_compare_gatk_var_anno_targeted_with_intersection.pl \n";
...
for (my $o = 0; $o <= $#sample; $o++) {
	...
	foreach my $p (@method) {
		...
		$FF = "</project/results/me/TES/$sample[$o]_FF/genotyper/anno/$sample[$o]_FF.bwa.ug.snp_${p}.genome_summary.csv";
		$FFPE = "</project/results/me/TES/$sample[$o]_FFPE/genotyper/anno/$sample[$o]_FFPE.bwa.ug.snp_${p}.genome_summary.csv";
		$WRITE_CON = ">/project/results/me/TES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FF_FFPE_${p}_targeted_con";
		$WRITE_DIS = ">/project/results/me/TES/SNV_comparison/genotyper/with_intersection/base_call/$sample[$o]_FF_FFPE_${p}_targeted_dis";
